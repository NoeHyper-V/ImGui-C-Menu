...
//#endif
    ...
    IMGUI_API bool          CustomBeginChildEx(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags);
    ...
    IMGUI_API bool          Tabs(bool selected, ImTextureID image, const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          SubTab(bool selectable, const char* label, const ImVec2& size_arg);
